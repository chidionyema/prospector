...
def main() -> int:
    ...
    print("CI runs. When it concludes green, MERGE IT YOURSELF:")
    print("    gh pr merge <n> --squash --delete-branch")
    print("automerge.yml used to do that. It was deleted on 2026-08-20 by founder decision: the")
    print("branch update it performed moved fifteen pull request heads and jammed the board for")
    print("thirty hours. Merging is the author's job now, and the author is you.")
    print("")
