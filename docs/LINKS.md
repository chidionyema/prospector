...
Status: INDEX. Last updated 2026-08-21.
...
| [Founder Board](https://claude.ai/code/artifact/0ff2b149-8578-465b-ac0b-352269fca941) | What is done, what is outstanding and what is at risk. Every row is a command rather than a claim, generated by `~/.claude/scripts/founder_board.py` | no file, chat only |
| [Engine Action Register](https://claude.ai/code/artifact/613f3292-586d-46a0-8503-bdf7fa9a70e5) | Every finding from the engine bench notes as a numbered action with a state: 3 shipped, 4 that only the founder can close, 11 an agent can move, 4 closed by a measurement and not to be rebuilt. Section 11 of the programme doc | `docs/ENGINE_100X_PROGRAM.md` |
| [Founder Board, earlier build](https://claude.ai/code/artifact/786c0e52-7c86-42f0-b3d9-42d57f46ea00) | Superseded by the Founder Board above. Listed so an older link still opens | no file, chat only |
...
| [The 30-Minute Migration](https://claude.ai/code/artifact/7838c636-c48b-4bb6-9a55-5a332ba196cc) | Where the portability kit stands against the 30-minute bar: 147 resources probed, 80 plan steps, 73 of them naming an adapter that is not on disk, and the six slices that close the gap in ascending blast radius | `docs/MIGRATION_AND_DR_PROGRAM.md` |
| [Cutover Eve](https://claude.ai/code/artifact/5c9a70cf-e000-4f63-a244-2f358228bfe6) | The migration plan the night before, and the three blockers that made zero downtime impossible: a 3600s DNS TTL against a 30-minute budget, an escape-hatch drill that failed twice at the pack step, and one SQLite file holding orders, entitlements and identity | no file, chat only |
| [The 1000x Arithmetic](https://claude.ai/code/artifact/7069e736-456a-4593-bf50-fb5330d8e28f) | What a 1000x engine target decomposes into, axis by axis | no file, chat only |
| [Engine Programme Bench Notes](https://claude.ai/code/artifact/3941ccea-077a-4bbe-87e1-1f52aa39e0dd) | The running research notes behind the engine programme. The Engine Action Register is the follow-through table built from them | no file, chat only |
| [Engine 100x Ledger](https://claude.ai/code/artifact/af5b236e-c7b1-467d-b806-b25f8e834a20) | Eleven verifier arms over thirteen runs: none beat the free `lex-token` baseline at 0.8273 AUC, none scored above chance on supported-versus-refuted, and the largest measured lever is 4.99x | no file, chat only |
| [The Price of Being Right](https://claude.ai/code/artifact/7f767fa5-802e-46db-9ca6-be9e76ff6021) | What grounded verification sells for: $10-$14 per 1,000 grounded calls across four providers, 11 of 13 products return citations only, and 0 of 13 rule on a claim and return the deciding passage | no file, chat only |
| [The Ship Gap](https://claude.ai/code/artifact/d9d98b93-fa67-42db-8406-9656bdfdd397) | Keep the machine, replace the skin. The working storefront is 556 lines and the other 5,049 are skin; route by route, with the six moves that shrink the gap | no file, chat only |
| [Hermes Untapped](https://claude.ai/code/artifact/3bb9e971-c5f5-45fc-8a66-f1433e87a11e) | The measured Hermes brief behind founder tasks #482-#486 | no file, chat only |
| [The Ledger](https://claude.ai/code/artifact/ad9fbfda-18af-4b87-872e-0e682f5d692d) | One of the two early samples, hand-built and containing no engine code. Kept as a before: it carries sections the engine's ten never had, including the verdict of the week and the numbered checks | no file, chat only |
| [The Instrument](https://claude.ai/code/artifact/a593d189-6479-4ddd-a6a9-d7faa037efe6) | The other early sample, on the same footing as The Ledger and kept for the same reason | no file, chat only |
| [Live Against The Early Two](https://claude.ai/code/artifact/c3e1677f-ef4c-4c95-a225-0490d71cc9b6) | The live site shot beside The Ledger and The Instrument at the same size, and the finding that neither early sample was made by the look engine | no file, chat only |

Fifteen of those eighteen exist **only** as a web page. If the page goes, the thinking goes. Pulling
...
| [The Leading Ten](https://claude.ai/code/artifact/86f324bb-7c48-4f27-b852-9376ed8f8dec) | A look is 36 numeric OKLCH decisions plus type, form and eight structural switches, which turns "best of the best" and "all ten totally different" from taste into a search with gates. Also how the ten get decided |
| [Ten Compositions](https://claude.ai/code/artifact/d4b7b419-cc1f-42a9-83f8-ac4735524fa9) | Each look composes its own first screen, so a Broadside opens like a poster and a Dossier like a memo. Before this, ten palettes shared one composition, which is why they all looked the same |
| [Ten Looks, live](https://claude.ai/code/artifact/31f23557-5fab-4f32-a756-d096eee1767f) | The look engine itself: switch identity, flip theme, roll an eleventh from a seed. The Sample Index names this as the page that was clicked through |
| [The Sample Index](https://claude.ai/code/artifact/74a95b41-805d-40ed-a580-2577c01ec26d) | Every sample made in the redesign sessions, and which page is canonical for each |
| [Redesign Desk](https://claude.ai/code/artifact/2073ea42-df41-482d-a252-f76b5cf1f2ca) | Superseded by The Sample Index. Listed so an older link still opens |
| [Ten Looks (Copy)](https://claude.ai/code/artifact/e9eee520-86f2-4469-8458-99c928cfe2dd) | Duplicate of Ten Looks. Listed so an older link still opens |
| [Ten Looks (Copy) (Copy)](https://claude.ai/code/artifact/1599d84f-5718-4d7a-8699-0d0dc36fac25) | Duplicate of Ten Looks. Listed so an older link still opens |
...
| [Proof Sheet 01](https://claude.ai/code/artifact/484ed3ae-dbfe-4aec-b039-da36a08d64cf) | Every look generated so far, one frame each, shot at the top of the full storefront page: 10 distinct plates, 10 treatments, 22 faces in play. All ten designed looks ship, so it is a roster rather than a shortlist |
