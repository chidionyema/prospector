...
| R12 | **Run our own ideas through the engine.** The product ideas this programme generates go through Prospector's own six checks, like any other candidate | "and also the run you idea through engine", "needs adding to requrenents" | **NOT STARTED** | blocked on A1 — see §2 |
