...
Two surfaces read the engine today: Telegram through `scheduler/status.py`, Streamlit through
`control_center/readers.py`. Two readers of one truth is the defect memory
