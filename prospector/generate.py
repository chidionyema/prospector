...
def _scoring_directive(cfg: Any) -> str:
    ...
    return (
        ...
        "not in the pitch:\n"
        "- money_provability: name what this buyer ALREADY spends to get this OUTCOME today — "
        "the adjacent invoice, the staff hours, the agency or professional fee, the fine, the "
        "paid workaround. It does NOT have to be a product like yours: a new solution to an "
        "already-funded job is exactly what scores well here. \"They would pay for this\" is "
        "not an answer. \"They already pay X to get Y done\" is.\n"
