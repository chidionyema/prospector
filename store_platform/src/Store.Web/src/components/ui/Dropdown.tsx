  ...
  return (
    <div ref={rootRef} className={cx('relative', className)}>
      ...
      <button
        ...
        className="flex h-11 w-full items-center justify-between gap-2 rounded-md border border-border-control bg-surface px-3 text-meta font-medium text-text sm:h-10 transition-colors duration-[120ms] ease-[cubic-bezier(0.2,0,0,1)] hover:border-text focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-focus"
      >
