            ...
            {categories.map((category) => (
              <li key={category.slug}>
                <Link
                  ...
                  className="flex h-full flex-col rounded-xl border border-border bg-surface p-6 transition-all duration-200 hover:-translate-y-0.5 hover:border-text/20 hover:shadow-[0_12px_28px_rgba(0,0,0,0.08)]"
                >
