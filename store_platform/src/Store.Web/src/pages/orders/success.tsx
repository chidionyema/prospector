    ...
    <MarketingLayout>
      ...
      <div className="flex min-h-[calc(100dvh-4rem)] items-center justify-center bg-bg px-6 py-16">
        <div className="flex w-full max-w-2xl flex-col items-center text-center gap-8">
          ...
          {phase === 'resolving' && (
            <div className="bg-white border border-border rounded-xl p-6 max-w-sm w-full text-left space-y-5">
          ...
          {(phase === 'no-session' ||
            ...
            phase === 'unfulfilled' ||
            phase === 'revoked') && (
            <div className="bg-white border border-border rounded-xl p-6 max-w-sm w-full text-left space-y-4">
              {phase === 'timed-out' && (
                <div className="h-1 w-full bg-border overflow-hidden rounded-full">
                  <div
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-2">
            <Link
              href="/"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl border border-border text-sm font-semibold text-text hover:bg-white transition-colors"
            >
              Browse more packs
            </Link>
            {packId && (
